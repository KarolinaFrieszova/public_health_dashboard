...
We used the Q&A session with ‘the client’ to check level of detail they wanted to see in the report, to ensure that we were following the biref correctly, and to ask 
